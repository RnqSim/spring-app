...
public class LocalServerReceiverHttps implements VerificationCodeReceiver {
     ...
     */
    public LocalServerReceiverHttps() {
    ...
    public static final class Builder {
        ...
        /** Builds the {@link LocalServerReceiverHttps}. */
        public LocalServerReceiverHttps build() {
            return new LocalServerReceiverHttps(
